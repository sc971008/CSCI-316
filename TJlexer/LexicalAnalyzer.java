  ...
  public static void nextToken() throws SourceFileErrorException
  {
    ...
    if (Character.isLetter((char) input.getCurrentChar())
      ...
      switch (input.getCurrentChar()) {
        case '0': /* unsigned integer 0 */ 
          currentToken = UNSIGNEDINT; tokenValue = currentValue = 0; input.nextChar(); return;          
        ...
        case '1': case '2': case '3': case '4': case '5': case '6': case '7': case '8': case '9':
          ...
          tokenValue = currentValue = Integer.parseInt(currentTokenString.toString());   
        ...
        case '"':
          ...
          while ((c = input.getCurrentChar()) != '"') {
            ...
            if (c == SourceHandler.eofDesignator)
              ...
              switch (input.getCurrentChar()) {
                ...
                case '\\': c = '\\'; break;
                case '"': c = '"'; break;
                default: throw new SourceFileErrorException("Illegal escape character.");
              }
            }
          ...
          if (input.getSourceFileReader().getLineNumber() != lineNum)
            throw new SourceFileErrorException("Multi-line string literals are not allowed.");
